                    ...
                    <div class="card card-body">
                        <form action="{{ route('tipo.store')}}" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Tipo de venta">
                            </div>
                            ...
                            <tr class="text text-center">
                                ...
                                <td class="text text-center" width="30px">
                                    <div class="row text text-center">
                                        <form action="{{route('tipo.destroy', $item->id)}}" method="post" class="text text-center ml-5">
                                            @csrf
                                            @method('DELETE')
