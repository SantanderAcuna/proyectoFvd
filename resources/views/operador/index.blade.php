            ...
            <div class="card-body">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                        <form action="{{ route('operador.store')}}" method="post">
                            @csrf
                            ...
                            <tr class="text text-center">
                                ...
                                <td class="text text-center" width="30px">
                                    <div class="row text text-center">
                                        <form action="{{route('operador.destroy', $item->id)}}" method="post" class="text text-center ml-5">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <a href="{{ route('operador.edit',$item->id)}}" class="btn btn-warning btn-sm ml-3 text text-center">
                                            Editar
