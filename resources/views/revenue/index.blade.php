                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr class="text text-center">
                                ...
                                <td class="text text-center" width="70px">{{$item->valor}}</td>

                                <td class="text text-center" width="30px">
                                    <div class="row text text-center">
                                        <form action="{{route('revenue.destroy', $item->id)}}" method="post" class="text text-center ml-5">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <a href="{{ route('revenue.edit', $item->id)}}" class="btn btn-warning btn-sm ml-3 text text-center">
                                            Editar
